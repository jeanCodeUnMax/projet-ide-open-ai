...
contextBridge.exposeInMainWorld('desktopAPI', {
  ...
  workspace: {
    ...
    renameEntry: (payload) => ipcRenderer.invoke('workspace:rename-entry', payload),
    moveEntry: (payload) => ipcRenderer.invoke('workspace:move-entry', payload),
    trashEntry: (payload) => ipcRenderer.invoke('workspace:trash-entry', payload),
